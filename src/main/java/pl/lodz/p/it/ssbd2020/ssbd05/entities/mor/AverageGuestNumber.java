...
@Setter
@Entity
@Table(name = "average_guest_number")
@TableGenerator(name = "AverageGuestNumberIdGen", table = "id_generator", pkColumnName = "class_name", pkColumnValue = "average_guest_number", valueColumnName = "id_range")
@NamedQueries({
